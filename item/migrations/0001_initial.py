# Generated by Django 3.0.3 on 2020-03-17 19:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(blank=True, default='не указано', max_length=50, null=True, verbose_name='Ед.Измерения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_slug', models.CharField(blank=True, max_length=255, null=True)),
                ('image', models.ImageField(blank=True, upload_to='manufactor_img/', verbose_name='Лого')),
                ('page_h1', models.CharField(blank=True, max_length=255, null=True, verbose_name='Тег H1')),
                ('page_title', models.CharField(blank=True, max_length=255, null=True, verbose_name='Title страницы')),
                ('page_description', models.CharField(blank=True, max_length=255, null=True, verbose_name='Description страницы')),
                ('page_keywords', models.TextField(blank=True, null=True, verbose_name='Keywords')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('subcategory', models.ManyToManyField(db_index=True, to='item.SubCategory', verbose_name='Отностится к подкатегориям')),
            ],
            options={

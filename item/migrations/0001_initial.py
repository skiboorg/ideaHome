    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_title', models.CharField(max_length=255, null=True, verbose_name='Title страницы')),
                ('page_description', models.CharField(max_length=255, null=True, verbose_name='Description страницы')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deep', models.CharField(blank=True, max_length=15, null=True, verbose_name='Глубина')),
                ...
                ('page_title', models.CharField(max_length=255, null=True, verbose_name='Title страницы')),
                ('page_description', models.TextField(null=True, verbose_name='Description страницы')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ManyToManyField(db_index=True, to='item.Category', verbose_name='Категории')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, null=True, verbose_name='Название производителя')),
                ('name_slug', models.CharField(blank=True, max_length=255, null=True)),
                ('image', models.ImageField(upload_to='manufactor_img/', verbose_name='Лого')),
                ('page_h1', models.CharField(max_length=255, null=True, verbose_name='Тег H1')),
                ('page_title', models.CharField(max_length=255, null=True, verbose_name='Title страницы')),
                ('page_description', models.CharField(max_length=255, null=True, verbose_name='Description страницы')),
                ('page_C', models.TextField(null=True, verbose_name='Keywords')),
                ('short_description', models.TextField(blank=True, verbose_name='Краткое описание для главной')),
                ('description', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Описание категории')),
                ('views', models.IntegerField(default=0)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, null=True, verbose_name='Название тега')),
                ('name_slug', models.CharField(blank=True, max_length=255, null=True)),
                ('seoText', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Текст для СЕО')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='item.Category', verbose_name='Относится к ')),
            ],
            options={
                'verbose_name': 'Фильтр',
        ...
        migrations.AddField(
            model_name='item',
            name='manufactor',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='item.Manufactor', verbose_name='Производитель'),
        ),
        migrations.AddField(
            model_name='item',
            name='subcategory',
            field=models.ManyToManyField(db_index=True, to='item.SubCategory', verbose_name='Подкатегории'),
        ),
        migrations.AddField(
            model_name='item',
            name='tag',
            field=models.ManyToManyField(db_index=True, to='item.Tag', verbose_name='Теги'),
        ),
    ]
